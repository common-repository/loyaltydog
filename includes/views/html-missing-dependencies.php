...
<div class="error">
    <p>
        <strong><?php esc_html_e( 'LoyaltyDog', 'loyaltydog' ); ?></strong> <?php esc_html_e( 'depends on the last version of WooCommerce to work!', 'loyaltydog' ); ?>
    </p>
	...
	<?php if ( $is_installed && current_user_can( 'install_plugins' ) ) : ?>
        <p>
            <a href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'plugins.php?action=activate&plugin=woocommerce/woocommerce.php&plugin_status=active' ), 'activate-plugin_woocommerce/woocommerce.php' ) ); ?>"
				...
				<?php esc_html_e( 'Active WooCommerce', 'loyaltydog' ); ?>
            </a>
        </p>
	<?php else : ?>
		<?php
        ...
        <p>
            <a href="<?php echo esc_url( $url ); ?>" class="button button-primary">
				<?php esc_html_e( 'Install WooCommerce', 'loyaltydog' ); ?>
            </a>
        </p>
	<?php endif; ?>
</div>
